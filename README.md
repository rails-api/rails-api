...
**IMPORTANT**: [Rails::API has been merged into Rails](https://github.com/rails/rails/pull/19832). Existing projects should [update rails-api to Rails 5 running in API mode](https://www.aaron-gray.com/updating-rails-api-to-rails-5-in-api-mode/).
